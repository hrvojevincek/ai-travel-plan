...
- **Maps & places** — MapLibre trip map (mapcn), Google Places autocomplete, pins, and photos
...
| Maps          | [mapcn](https://www.mapcn.dev) (MapLibre), Google Places, Geocoding |
...
| `NEXT_PUBLIC_GOOGLE_MAPS_BROWSER_KEY`                 | No       | Places Autocomplete (map works without it)                 |
| `MAPS_PHOTO_SECRET`                                   | No\*     | HMAC for the map photo proxy (\*required for popup photos) |
